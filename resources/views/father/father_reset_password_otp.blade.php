        ...
        <div class="container my-auto">
          <div class="row no-gutters h-100">
            <div class="col-11 col-sm-9 col-md-7 col-lg-5 col-xl-4 m-auto py-5">
             ...
             <p class="lead text-center mb-3">تغيير كلمة المرور</p>
                    @include('father.parts.success')
@include('father.parts.errorr')
              <form id="loginForm" method="post" action="{{route('send_otp')}}">
                  @csrf
                <div class="vertical-input-group">
                  <div class="input-group">
                    <input type="number" class="form-control mb-1" name="otp" id="emailAddress" required placeholder="ادخل رمز التاكيد" style="height: 45px;">
                  </div>
                  <div class="input-group">
                    <input type="password" class="form-control" name="new_password" id="loginPassword" required placeholder="كلمة مرور جديدة" style="height: 45px;">
                  </div>

                  <div class="input-group">
                    <input type="password" class="form-control"  name="replay_password" id="loginPassword" required placeholder="تاكيد كلمة المرور" style="height: 45px;">
                  </div>
                </div>
                <button class="btn btn-primary btn-block shadow-none my-4" type="submit" style="height: 45px;">تاكيد</button>
              </form>
            </div>
          </div>
        </div>
