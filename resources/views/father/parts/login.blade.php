...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('dashbord_style/app-assets/css-rtl/pages/login.css')}}">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
    ...
    <form class="login-form" method="post" action="{{ route('post_login') }}">
      ...
      <div class="row margin">
        <div class="input-field col s12">
          ...
          <label for="username"  class="center-align">البريد الإلكتروني</label>
        </div>
      </div>
      <div class="row margin">
        <div class="input-field col s12">
      ...
      <div class="row">
        <div class="input-field col s12" style="color: white">
            <input type="submit" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12" value="تسجيل دخول">
        </div>
      </div>
