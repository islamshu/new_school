        ...
        <div class="container">
          <div class="row">
            <div class="col s10 m6 l6 breadcrumbs-left">
              <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>انشاء رأي جديد</span></h5>
            ...
            <div class="card-content">
              ...
              <div id="view-basic-demo">
                <div class="row">
                  ...
                  <form class="col s12" method="post" action="{{ route('review.store') }}" enctype="multipart/form-data">
                      @csrf
