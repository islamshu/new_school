            ...
            <div class="card-content">
              ...
              <div id="view-basic-demo">
                <div class="row">
                  ...
                  <form class="col s12" method="post" action="{{ route('employes.update',$employee->id) }}">
                      @csrf @method('put')
                    <div class="row">
                    ...
                    <select required  name="social_status">
                              <option value="1"   @if( $employee->social_status  == 1)   selected  @endif>عزباء</option>
                              <option value="2"   @if( $employee->social_status  == 2)   selected  @endif >متزوجة</option>
                              <option value="3"   @if( $employee->social_status  == 3)   selected  @endif >مطلقة</option>
                              <option value="4"   @if( $employee->social_status  == 4)   selected  @endif >أرملة</option>
                   ...
                   <input required id="job" type="text"
                       ...
                       <select  required name="branch_id">
                               <option value="1" @if($employee->branch_id == 1  ) selected @endif>عبري</option>
                            <option value="2"   @if($employee->branch_id == 2  ) selected  @endif>عبري 2</option>
                            <option value="3"  @if($employee->branch_id == 3  ) selected  @endif>المعبيلة</option>
                            <option value="4"  @if($employee->branch_id == 4  ) selected   @endif>المعبيلة حلقة اولى (1-4)</option>
                            <option value="5"  @if($employee->branch_id == 5  ) selected @endif >الهيال</option>
                            <option value="6"  @if($employee->branch_id == 6  ) selected  @endif>الموالح</option>
                        </select>
                    ...
                    <div class="row">
                        <div class="input-field ">
                          <div class="input-field col m8 s12">
                              ...
                              <textarea required name="experience" id="ckeditor" class="form-control ckeditor" cols="30" rows="5">{{    $employee->experience   }}</textarea>
                            </div>
                      ...
                      <div class="row">
                        <div class="input-field ">
                          <div class="input-field col m8 s12">
                              ...
                              <textarea required name="courses" id="ckeditor" class="form-control ckeditor" cols="30" rows="5">{{      $employee->courses   }}</textarea>
                            </div>
