         ...
         <div class="menu-options-form row">
            <div class="input-field col s12 menu-color mb-0">
               ...
               <div class="gradient-color center-align">
                  ...
                  <span
                     class="menu-color-option btn-danger"
                     data-color="btn-danger"
                  ></span>
                  <span
                     class="menu-color-option btn-info "
                     data-color="btn-info "
                  ></span>
                  <span
            ...
            <div class="input-field col s12 menu-bg-color mb-0">
               ...
               <div class="gradient-color center-align">
                  ...
                  ></span>
                  <span
                     class="menu-bg-color-option btn-danger"
                     data-color="btn-danger"
                  ></span>
                  <span
                     class="menu-bg-color-option btn-info "
                     data-color="btn-info "
                  ></span>
                  <span
      ...
      <div class="navbar-options row">
         <div class="input-field col s12 navbar-color mb-0">
            ...
            <div class="gradient-color center-align">
               ...
               <span
                  class="navbar-color-option btn-danger"
                  data-color="btn-danger"
               ></span>
               <span
                  class="navbar-color-option btn-info "
                  data-color="btn-info "
               ></span>
