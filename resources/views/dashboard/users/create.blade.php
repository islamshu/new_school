        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6 breadcrumbs-left">
                    <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>انشاء موظف جديد
                        </span></h5>
                    ...
                    <div id="view-basic-demo">
                        <div class="row">
                            ...
                            <form class="col s12" method="post" action="{{ route('users.store') }}"
                                ...
                                @csrf
                                <div class="row">
                                    <label for="icon_prefix3" class="">أسم الموظف </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col m6 s6">
                                        <input id="icon_prefix31" type="email" value="{{ old('email') }}" name="email"
                                            class="validate">
                                    </div>

                                </div>
                                <div class="row">
                                    <label for="icon_prefix32" class="">كلمة المرور </label>

                                    <div class="input-field col m6 s6">
                                        <input id="icon_prefix32" type="password" name="password" class="validate">
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <label for="icon_prefix31" class="">الدور </label>

                                            <div class="form-line">
                                                <select required value="{{ old('roles_name[]') }}" class="form-control"
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <label for="icon_prefix31" class="">القرع </label>
