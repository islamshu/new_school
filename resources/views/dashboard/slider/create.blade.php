        ...
        <div class="container">
          <div class="row">
            <div class="col s10 m6 l6 breadcrumbs-left">
              <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>انشاء سلادير جديد</span></h5>
            ...
            <div class="card-content">
              ...
              <div id="view-basic-demo">
                <div class="row">
                  ...
                  <form class="col s12" method="post" action="{{ route('slider.store') }}" enctype="multipart/form-data">
                      @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                          ...
                          <input id="icon_prefix3" type="text" value="{{ old('text_link') }}" name="text_link" class="validate">
                          <label for="icon_prefix3" class="">جملة (button)</label>
                        </div>
                        <div class="input-field col s6">
                          <i class="material-icons prefix">timeline</i>
                          <input id="icon_telephone" type="text"  name="link" class="validate">
